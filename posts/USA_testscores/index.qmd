...
And Iowa, because Iowa is apparently super proficient. I wonder how different proficiency standards are across states.
...
- Find the code for this visualization on [Smrithi's Github](https://github.com/smrithi-sunil). [^3] [^4]
...
[^3]: [Smrithi's Github](https://github.com/smrithi-sunil)
