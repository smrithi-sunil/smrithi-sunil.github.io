...
However, as more data emerged from developing countries, a different pattern became clear: many LBW babies were born at full-term. In these regions, LBW was more often due to intrauterine growth restriction (IUGR), which is a condition where the fetus does not grow as expected, rather than early delivery.
